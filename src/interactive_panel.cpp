                                     ...
                                     QWidget *)
{
    ...
    closeBtn->addButton(tr("closure"), QDialogButtonBox::AcceptRole);
    connect(closeBtn, SIGNAL(accepted()), this, SLOT(accept()));

    checkbox=new QCheckBox("Highlight the origin point cloud");
    connect(checkbox,SIGNAL(stateChanged(int)),this,SLOT(ChangeColor(int)));
    checkbox2=new QCheckBox("Highlight point cloud");
    ...
    clock_t start=clock();
    PointCloud::Ptr cloud_src_origin (new PointCloud);
    *cloud_src_origin=*(cloud_src_ptr->getCloud3DPtr());
    PointCloud::Ptr cloud_tgt_origin (new PointCloud);
    *cloud_tgt_origin=*(cloud_tgt_ptr->getCloud3DPtr());
    ...
    qDebug()<<"Boundary size of the source point cloud:"<<length_src;
    qDebug()<<"The boundary size of the target point cloud:"<<length_tgt;
 ...
 //   voxelFilter(cloud_src_origin,cloud_src,cloudsize*1.0/100000000);
    ...
    qDebug()<<"downsampling point size"<<cloudtgtsize;
